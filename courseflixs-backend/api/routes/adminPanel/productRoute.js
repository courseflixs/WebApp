...
const {
  retreiveProduct, addProduct, updatingProduct, deletingProduct, updatingLockUnlockStatus,
} = require('../../controllers/adminPanel/productController');

const pathToCreate = './public/images/products/';
// image upload code
